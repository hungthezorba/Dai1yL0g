...
| Task adds Expo native modules or Expo Router navigation hooks | Read `docs/decisions/0008-expo-sdk56-router-and-optional-native-modules.md` and confirm whether a dev client rebuild is required; never top-level-import packages that call `requireNativeModule` for optional features. |
